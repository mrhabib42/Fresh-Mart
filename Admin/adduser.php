            ...
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name="u_image" type="file" id="formFile"  required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="u_address" style="height: 100px" required></textarea>
                  </div>
                </div>
...
$imgName = $uemail.$uimage['name'];
    ...
    if($res)
    {
      echo"<script> window.location.assign('./showuser.php')</script>";
    }
    else 
    {
